...
parent.removeChild(el)},makeEventFnc:function(getPoint,process){return function(e){if(!this.rect)
this.rect=this.renderer.domElement.getBoundingClientRect();const pointer=getPoint(e);const intersects=this.getIntersectObj(pointer,camera,scene);if(intersects[0])
