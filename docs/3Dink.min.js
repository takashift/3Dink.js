...
else if(style.cursor!==this.cursorOn3Dink){style.cursor=this.cursorOn3Dink;this.resetShineModel(selectedMatl)}},changeCursorFn:function(){const style=renderer.domElement.style;if(this.itsModel){if(this.itsModel.link||this.itsModel.parent.link){this.setParentObj();if(this.itsModel.link.url){style.cursor=this.cursorDefault}
